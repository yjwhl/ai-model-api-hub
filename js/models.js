...
const MODELS_DATA = {
    ...
    models: [
        ...
        },
        {
            ...
            contextLabel: "256K",
            features: ["K2万亿参数MoE", "256K超长上下文", "长文本处理", "文档摘要"],
            specialties: "K2系列2026年发布，万亿参数MoE架构，256K超长上下文",
            scenarios: ["长文档处理", "书籍摘要", "合同分析", "复杂推理"],
            capabilities: {
                coding: 5,
                reasoning: 5,
                chinese: 5,
            ...
            category: ["tier2", "longcontext", "china", "reasoning"],
        ...
        },
        {
            ...
            contextWindow: 256000,
            contextLabel: "256K",
            features: ["深度推理增强", "缓存命中低价", "256K上下文", "复杂问题"],
            specialties: "K2推理增强版，缓存命中仅0.6元/百万tokens，性价比极高",
            scenarios: ["复杂推理", "数学计算", "深度分析"],
            capabilities: {
                coding: 5,
                reasoning: 5,
                chinese: 5,
            ...
            badges: ["china", "hot", "new"],
            category: ["tier2", "reasoning", "china", "value"],
            url: "https://platform.moonshot.cn",
            chinaAccessible: true
        },
        {
            ...
            contextWindow: 256000,
            contextLabel: "256K",
            features: ["开源可商用", "思维链支持", "代码能力强", "中文优化"],
            specialties: "阿里2026年旗舰模型，支持思维链，Qwen3系列开源可商用",
            scenarios: ["复杂推理", "代码生成", "内容创作"],
            capabilities: {
                coding: 5,
                reasoning: 5,
                chinese: 5,
            ...
            category: ["tier1", "opensource", "china", "coding"],
